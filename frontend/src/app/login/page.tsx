...
import { Stethoscope, Mail, Lock, ArrowRight, ArrowLeft, AlertCircle, ServerCrash } from 'lucide-react';
      ...
      <div className="w-full max-w-md mx-auto flex flex-col items-center justify-center min-h-screen px-4 py-12 relative z-10">
        ...
        <div className="auth-card fade-in-up">
          <div className="text-center mb-8">
            ...
            <p className="body-sm">Log in to access your MediHub account</p>
          </div>
          ...
          <div className="text-center">
            <p className="body-sm">
              ...
              <Link href="/signup" className="text-[var(--color-blue-primary)] font-semibold hover:text-[var(--color-navy-hover)] transition-smooth">
                Sign Up
              </Link>
            </p>
          </div>
